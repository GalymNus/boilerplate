...
const mergeArray = (initialData: IinitialData[], data: any) => {
...
class Querry extends React.PureComponent {
  ...
  requestByEndpoint = async (newParams: any) => {
    console.log(newParams);
    // const { initialData, endpoint, variables, path, normalizer } = this.props;
    try {
      // if (initialData) {
  ...
  render() {
    ...
    //   error,
    //   data,
    //   refetch: this.requestByEndpoint
    // });
  }
}
...
// const EnchantedQuerry = compose(withState)(Querry);
